...
INSERT INTO `employees` (`employeeID`, `id`, `password_hash`, `role`) VALUES
	...
	('1122', 2, '249', 'user'),
	('12', 3, '3', 'user'),
	('1234567890', NULL, '$2y$10$Mju1LxOquMakGntrDaTcfeoSrJkTkw4BK0raydD3GfXjHloSx9Ama', NULL),
	('1234567891', NULL, '$2y$10$oaug./DtizC53CUlh1vc2eai6bWiCLb38vLFDRttNBOqC04XgShBm', NULL);

-- Dumping structure for table smarttrack_db.inventories
...
-- Dumping data for table smarttrack_db.inventories: ~10 rows (approximately)
INSERT INTO `inventories` (`ProductID`, `Location`, `ProductName`, `Stock`) VALUES
...
-- Dumping structure for table smarttrack_db.suppliers
...
-- Dumping data for table smarttrack_db.suppliers: ~4 rows (approximately)
INSERT INTO `suppliers` (`CompanyName`, `Phone`, `Email`, `Address`) VALUES
