...
INSERT INTO `employees` (`EmployeeID`, `id`, `PasswordHash`, `Role`) VALUES
	('1020', 1, '194', 'user'),
	('1122', 2, '249', 'user'),
	('12', 3, '3', 'user'),
	('12.1', NULL, '3', 'user'),
...
-- Dumping data for table smarttrack_db.item: ~99 rows (approximately)
...
-- Dumping data for table smarttrack_db.test: ~1 rows (approximately)
